package generate_refresh_token
...
func New(log *slog.Logger, authService auth.Service, appService app.Service, refreshTokenService token.Service) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		const op = "handlers.tokens.generate_refresh_token.New"
		...
		newToken, err := refreshTokenService.RegenAndSaveToken(APIKeyDTO.UserID, appDTO)
		if err != nil {
			return
		}
